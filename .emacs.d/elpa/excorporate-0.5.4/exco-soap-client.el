;;;; exco-soap-client.el -- Access SOAP web services  -*- lexical-binding: t -*-
...
(defun soap-validate-xs-simple-type (value type)
  ...
  (let* ((base-type (soap-xs-simple-type-base type))
    ...
    (if (listp base-type)
      ...
      (flet ((fail-with-message (format value)
